...
smile = read_rows('rough_smile.csv')
term = read_rows('rough_term_structure.csv')
svi = read_rows('rough_vs_svi.csv')
var = read_rows('rough_mc_variance.csv')
calib_path = base / 'rough_calibration_noise.csv'
calib = read_rows(calib_path) if calib_path.exists() else []
