...
render_line_panel('Smile Comparison', slice_rows, 'smile', 'model_comparison_smile.svg')
render_line_panel('ATM Term Structure Comparison', slice_rows, 'term', 'model_comparison_term.svg')
render_bar_panel('Surface Calibration Error', rmse_rows, 'model_comparison_rmse.svg')
